...
> - Las herramientas externas mencionadas (Jasper, Agility Writer, ContentBot, Canva, Midjourney, etc.) son **referencia informativa** — no puedes ejecutarlas. Usa tus propias capacidades y la herramienta de generación de imágenes.
> - **Delimitación con otras skills:**
...
>   - `content-marketer` (esta skill) → Estrategia global: qué publicar, dónde, cuándo, y cómo distribuirlo
